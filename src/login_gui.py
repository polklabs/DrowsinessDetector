...
def register_user():
	...
	if user == None:
		...
		register_success.geometry("400x100")
		Tkinter.Label(register_success, text="Registration complete! Restart the program to login.").pack()
		Tkinter.Button(register_success, text="OK", command=delete_register_success).pack()
